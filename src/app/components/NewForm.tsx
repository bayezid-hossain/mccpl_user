...
import { z } from 'zod';
import { FormDataSchema } from '@/models/formSchema';
...
const steps = [
  ...
  { id: 'Step 3', name: 'Make Payment' },
  { id: 'Step 4', name: 'Submit Application' },
];
      ...
      <nav aria-label="Progress">
        <ol role="list" className="flex items-start justify-evenly gap-8">
          {steps.map((step, index) => (
            ...
            >
              {currentStep > index ? (
                <div className="group flex w-full flex-col items-start justify-center border-t-4 border-sky-600 transition-colors pt-4 ">
                ...
                <div
                  className="flex w-full flex-col items-start justify-center border-t-4 border-sky-600 pt-4"
                  aria-current="step"
                >
